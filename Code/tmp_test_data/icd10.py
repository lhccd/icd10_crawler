...
class MuncherySpider():
    def __init__(self):
        self.url_to_crawl = "http://apps.who.int/classifications/icd10/browse/2016/en#/i"
        self.all_items = []
...
#        self.display.start()
        self.driver = webdriver.Chrome("/PyCharmProjects/ICD_10_Scraper/chromedriver_for_mac)
        sleep(4)
